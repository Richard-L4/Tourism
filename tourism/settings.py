...
# 1. Try to get settings from env.py, otherwise use safe defaults
if env:
    SECRET_KEY = env.SECRET_KEY
    DEBUG = env.DEBUG
else:
    # This is the "Emergency Mode" if env.py is missing
    SECRET_KEY = 'django-insecure-fallback-key-for-local-dev'
    DEBUG = True
# REMOVE the extra "DEBUG = True" line further down!
